...
def plot_policy_behavior_curves(results_data, metric, title=None, save_path=None):
    assert metric in ['policy_loss', 'total_loss', 'entropy_loss', 'kl_divergence'], \
...
if __name__ == "__main__":
    json_path = "results/MiniGrid-Empty-5x5-v0_results.json"
    ...
    plot_policy_behavior_curves(results, metric="kl_divergence")
